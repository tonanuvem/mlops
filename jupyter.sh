...
docker run -it --name jupyter --rm -p 8888:8888 -v "$dir":/home/jovyan/work -v "$dir/exemplo/treinamento.ipynb:/home/jovyan/treinamento.ipynb" -d jupyter/scipy-notebook \
